...
#include "../global_matrices/create_full_matrices_cls.h"
#include "../global_matrices/create_global_matrices_cls.h"
#include "../load/Load.h"
#include "../mesh/discretize_the_domain_cls.h"
...
public:
  frequency_domain_analysis(main_ns::address_ns::address_cls *,
